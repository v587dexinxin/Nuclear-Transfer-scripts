# -*- coding: utf-8 -*-
"""
Created on Wed Feb 20 20:54:52 2019
...
def caxis_H(ax):
    ...
    ax.tick_params(axis = 'both', bottom = False, top = False, left = False,
                   ...
                   labelleft = False, labelright = False , length = 5)
...
OutFolder = '/public/home/xxli/data/BDF1_New/HiC/Plot/selected_interval_20K_loop_0.05'
LoopFolder = '/public/home/xxli/data/BDF1_New/HiC/Loop/Raw_20K_0.05'
...
selected_interval = [('3' , 33760000 , 35680000 , 'Sox2') , ('4' , 55200000 , 57000000 , 'Klf4') , ('17' , 35280000 , 36360000 , 'Oct4') , 
                     ('6' , 121400000 , 123320000 , 'Nanog') , ('12' , 86080000 , 87120000 , 'Esrrb') , ('2' , 106900000 , 108000000 , 'Fig2')]


for c in cell:
    OutFil = 'Heatmap_' + c + '_selected_20K_3_4.pdf'
    HiCData = HiC_Data[c]
    LoopFil = 'Cluster_' + c + '_loops20K_3.txt'
...
#        extract_raw = loops_raw[mask_raw] 
        for p in extract:
            ...
            y = p['end'] // R - startHiC
            ax.scatter(y + 0.5 ,x + 0.5 , color = '', edgecolors = 'black', s = 200)
...
#            ax.text(y + 1.5 , x + 1 , str(round(strength,2)) , size = 15)
        ...
        ## Colorbar
        ax = fig.add_axes([Left + 0.3 , HB - 0.11 , 0.1 , 0.035])
