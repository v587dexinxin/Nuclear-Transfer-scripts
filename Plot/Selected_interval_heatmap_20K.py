# -*- coding: utf-8 -*-
"""
Created on Mon Nov 12 09:47:05 2018
...
def Get_loops(LoopSource):
    ...
    """
    loops = []
    Loop = np.loadtxt(LoopSource, usecols = (0,1,2) , dtype = loop_type, skiprows = 0)
    for i in Loop:
...
OutFolder = '/public/home/xxli/data/BDF1_New/HiC/Plot/selected_interval'
LoopFolder = '/public/home/xxli/data/BDF1_New/HiC/Loop/Raw_20K'
LoopFil = 'union_sites_20K.txt'
LoopSource = os.path.join(LoopFolder , LoopFil)
f = '/public/home/xxli/data/BDF1_New/HiC/Plot/selected_interval/Selected_intervals.txt'
...
selected_interval = np.loadtxt(f , dtype = loop_type)
LoopData = Get_loops(LoopSource)

    
for c in cell:
    OutFil = 'Heatmap_' + c + '_selected_20K.pdf'
    ...
    LoopFil = 'Clustered_' + c + '_loops_20K.txt'
    ...
    for i in selected_interval:
        ...
        for p in extract:
            ...
            y = p['end'] // R - startHiC
            ax.scatter(y + 0.5 ,x + 0.5 , color = '', edgecolors = 'b', s = 80)
        ...
        ## Colorbar
        ax = fig.add_axes([Left + 0.3 , HB - 0.1 , 0.3 , 0.035])
