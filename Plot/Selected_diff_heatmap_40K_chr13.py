# -*- coding: utf-8 -*-
"""
Created on Fri May 01 14:33:39 2020
...
selected_interval = [('13' , 19400000 , 25600000 , 'NT_fESC_difference')]
...
pp = PdfPages('D:\\ntESC_3Dreprogramming\\Figures\\Plot\\Fig6_figs\\fESC_NT_diff_heatmap_40K_chr13_19.4_25.6.pdf')
...
for i in selected_interval:
    ...
    cylim = ax1.get_ylim()
    ## Ticks and Labels
    ticks = [0 , 22400000 // 40000 - startHiC , 22600000 // 40000 - startHiC , endHiC - startHiC]
