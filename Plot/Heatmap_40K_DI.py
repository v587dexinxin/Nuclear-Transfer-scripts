# -*- coding: utf-8 -*-
"""
Created on Fri Jan 18 20:08:49 2019
...
size = (12, 12)
Left = 0.15 ; HB = 0.1 ; width = 0.7 ; HH = 0.7
...
pp1 = PdfPages('D:\\Workspace_New\\Plot\\Figure1\\HiC-Heatmap\\new\\Selected_CCS_40K_Heatmap_stable_window_wise_600K.pdf')
pp2 = PdfPages('D:\\Workspace_New\\Plot\\Figure1\\HiC-Heatmap\\new\\Selected_NT5_40K_Heatmap_stable_window_wise_600K.pdf')
pp3 = PdfPages('D:\\Workspace_New\\Plot\\Figure1\\HiC-Heatmap\\new\\Selected_NT6_40K_Heatmap_stable_window_wise_600K.pdf')
pp4 = PdfPages('D:\\Workspace_New\\Plot\\Figure1\\HiC-Heatmap\\new\\Selected_fESC_40K_Heatmap_stable_window_wise_600K.pdf')
...
for i in interval:
    ...
    for c in cell:
        ...
        caxis_H(ax1)
        ## Colorbar
        ax2 = fig.add_axes([Left + 0.6 , HB - 0.05 , 0.1 , 0.035])
