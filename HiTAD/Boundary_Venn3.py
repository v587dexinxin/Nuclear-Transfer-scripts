# -*- coding: utf-8 -*-
"""
Created on Thu Mar 12 21:39:15 2020
...
run_Plot(fig , 'D:\\ntESC_3Dreprogramming\\Figures\\Plot\\Fig5_figs\\CCS_NT(common)fESC_Boundary_Venn3.pdf')

for cl in boundaries:
    out = open('H:\\Workspace_New\\data\\HiC\\HiTAD\\respective\\stable_600K\\bottom_domain\\Boundary_Venn3_genes\\boundary_classify\\Boundary_' + cl + '.txt' , 'w')
...
run_Plot(fig , 'D:\\ntESC_3Dreprogramming\\Figures\\Plot\\S7_figs\\common_NT_fESC_Venn2.pdf')
...
for k,v in genes.items():
    print k , len(v)
    Write2genes('H:\\Workspace_New\\data\\HiC\\HiTAD\\respective\\stable_600K\\bottom_domain\\Boundary_Venn3_genes\\' + k + '_genes.txt' , v)                
