...
CCS_Lib = np.load('H:\\Workspace_New\\data\HiC\\Matrix\\Matrix_40K\\fESC_40K\\Correct_Merged_Reps_Local_Chromosome_Matrix.npz')
CCS_Lib = CCS_Lib['Matrix'][()]
fESC_Lib = np.load('H:\\Workspace_New\\data\HiC\\Matrix\\Matrix_40K\\fESC_40K\\Correct_Merged_Reps_Local_Chromosome_Matrix.npz')
fESC_Lib = fESC_Lib['Matrix'][()]
NT5_Lib = np.load('H:\\Workspace_New\\data\HiC\\Matrix\\Matrix_40K\\NT5_40K\\Correct_Merged_Reps_Local_Chromosome_Matrix.npz')
NT5_Lib = NT5_Lib['Matrix'][()]
NT6_Lib = np.load('H:\\Workspace_New\\data\HiC\\Matrix\\Matrix_40K\\NT6_40K\\Correct_Merged_Reps_Local_Chromosome_Matrix.npz')
...
for c in ['CCS']:
    pp = PdfPages('D:\\ntESC_3Dreprogramming\\Figures\\Plot\\Fig2_figs\\fESC_Boundary_nearby_interaction_40K.pdf')
    HiC_Lib = HiC_Data[c]
    Tad_Lib = Tad
    ...
    ax.set_xlabel('fESC_Insulation' + str(np.round(insulation,4)), fontsize = 30 )
    caxis_H(ax)
    ##-----------------------colorbar--------------------------------------------------------------------------
