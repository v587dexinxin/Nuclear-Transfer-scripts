# -*- coding: utf-8 -*-
"""
Created on Sat Nov 24 19:00:45 2018
...
pp = PdfPages('H:\\Workspace_New\\Plot\\Figure1\\Correlation\\replicated_scatter\\Compartment_200K_1.pdf')
for c in cell:
    PC_R1 = np.loadtxt(os.path.join(PCFolder , c + '_R1_compartment_200K.txt') , dtype = sig_type)
    PC_R2 = np.loadtxt(os.path.join(PCFolder , c + '_R2_compartment_200K.txt') , dtype = sig_type)
