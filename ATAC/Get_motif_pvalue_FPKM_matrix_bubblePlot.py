# -*- coding: utf-8 -*-
"""
Created on Tue Jan 14 10:49:00 2020
...
#Cluster2_cluster3
gene_name = ['Batf','Atf2','Gata1','Bach2','Fosl2','Fosl1','Runx2','Runx1','Junb','Jun','Nanog','Zic3','Pou3f1','Pou5f1','Sox3','Sox2','Klf4','Klf6']
TF_name = ['BATF','Atf2','Gata1','Bach2','Fosl2','Fra1','RUNX2','RUNX1','JunB','Jun','Nanog','Zic3','Oct6','Oct4','Sox3','Sox2','Klf4','KLF6']
...
bubble = ax.scatter(x, y , s = np.array(z) / 2 + 100, c = np.array(fpkm) + 0.5, cmap = cm, linewidth = 0.5 , edgecolors = 'black')
...
ax.scatter([1,1,1] , [1,1.45,2.0] ,s = [100 , 350 , 650] , marker = 'o' , c = 'white' ,linewidth = 0.5,edgecolors = 'black')
ax.set_ylim((0.7,2.3))
run_Plot(fig , 'D:\\ntESC_3Dreprogramming\\Figures\\Fig1\\new\\Allpeaks_classify_motif_bubble_1.pdf')
...
fig = plt.figure(figsize = (10 , 12))
ax = fig.add_axes([Left  , HB , width , HH])
bubble = ax.scatter(x, y , s = np.array(z) * 10 + 100, c = np.array(fpkm) + 0.5, vmin = 0.6 , vmax = 9.0 , cmap = cm, linewidth = 0.5 , edgecolors = 'black')
#ax.scatter([x, y , s = np.array(z) / 2 + 5, c = np.array(fpkm) + 0.5, cmap = cm, linewidth = 0.5, alpha = 0.8)
ax.grid()
...
ax = fig.add_axes([Left + width + 0.05  , HB , 0.2 , 0.15])
ax.scatter([1,1,1] , [1.0, 1.45,2.0] ,s = [100 , 350 , 600] , marker = 'o' , c = 'white' ,linewidth = 0.5,edgecolors = 'black')
ax.set_ylim((0.7,2.3))
