# -*- coding: utf-8 -*-
"""
Created on Tue Mar 30 15:33:13 2021
...
Repro = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\Repro_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )
Resis = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\Resis_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )
Over = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\Over_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )
Others = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\Others_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )

A_B_Repro = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\A_B_Repro_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )
A_B_Resis = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\A_B_Resis_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )
A_B_Over = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\A_B_Over_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )

B_A_Repro = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\B_A_Repro_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )
B_A_Resis = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\B_A_Resis_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )
B_A_Over = np.loadtxt('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\\HICCUPS\\Clustered_new\\classify_loops_weix\\B_A_Over_Loops_NT_fESC_merged_20K.txt' , dtype = tad_type )
...
for k,v in genes.items():
    ...
    Write2genes('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\HICCUPS\\Clustered_new\\classify_loops_weix\\Loop_related_genes\\' + k + '_genes.txt' , tmp_genes)                
    Write2fils_nochr('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\HICCUPS\\Clustered_new\\classify_loops_weix\\Loop_related_genes\\' + k + '_genes_ID.txt' , tmp_gene_id)       
...
ax.text(0.7 , percent['Repro'] + 0.01 ,  np.round(percent['Repro'] , 4))
ax.text(1.7 , percent['Resis'] + 0.01 ,  np.round(percent['Resis'] , 4))
ax.text(2.7 , percent['Over'] + 0.01 ,  np.round(percent['Over'] , 4))
ax.text(3.7 , percent['Others'] + 0.01 ,  np.round(percent['Others'] , 4))

ax.set_xticks([1 , 2 , 3 , 4])
ax.set_xticklabels(['Repro' , 'Resis' , 'Over' , 'Others'])
ax.set_xlim((0.5 , 4.5))
ax.set_ylim((0 , 0.4))
ax.set_ylabel('DEG percent')

run_Plot(fig , 'F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\HICCUPS\\Clustered_new\\classify_loops_weix\\plot\\Loop_DEG_percent.pdf')
...
for k,v in diff.items():
    ...
    print (k , len(tmp_genes))
    Write2genes('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\HICCUPS\\Clustered_new\\classify_loops_weix\\Loop_related_genes\\Loop_related_DEGs\\' + k + '_DEGs.txt' , tmp_genes)                
    Write2fils_nochr('F:\\work\\ntESC_3Dreprogramming\\Workspace_New\\data\\HiC\\Loop_new\HICCUPS\\Clustered_new\\classify_loops_weix\\Loop_related_genes\\Loop_related_DEGs\\' + k + '_DEGs_ID.txt' , tmp_gene_id)       
